    ...
    <header>
        <div class="site-heading text-right text-faded d-none d-lg-block">
            <ul class="nav justify-content-end">
                ...
                <li class="nav-items">
                    <a href="memberInfo.html"><img src="./img/header/h1.png" class="nav-link-img" style="width: 28px; height: 28px;"></a>
                </li>
                <li class="nav-item">
                    <a href="parsel.html"><img src="./img/header/h2.png" class="nav-link-img" style="width: 28px; height: 28px;"></a>
                </li>
                <li class="nav-item">
                    <a href="cart.html"><img src="./img/header/h3.png" class="nav-link-img" style="width: 28px; height: 28px;"></a>
                </li>
            </ul>
        </div>
        <h2 class="site-heading text-left text-faded d-none d-lg-block">
            <img src="./img/header/logo_main.png" class="site-heading img-point">
        </h2>
    </header>
    <nav class="navbar navbar-expand-lg navbar-dark py-lg-2" id="mainNav">
        <div class="container">
            <a class="navbar-brand fw-bold d-lg-none" href="index.html">STARBUCKS</a>
        </div>
    </nav>
